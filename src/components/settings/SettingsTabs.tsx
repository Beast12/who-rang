  ...
  return (
    <Tabs defaultValue="webhook" className="space-y-6">
      <TabsList className="grid w-full grid-cols-3 sm:grid-cols-6 bg-muted">
        <TabsTrigger
          value="webhook"
          className="h-10 flex items-center justify-center sm:justify-start space-x-1 sm:space-x-2 px-2 sm:px-3 data-[state=active]:bg-background data-[state=active]:text-foreground"
        >
