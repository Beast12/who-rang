...
const Faces = () => {
  ...
  const handleDeletePerson = (id: number, name: string) => {
    if (
      window.confirm(
        `Are you sure you want to delete ${name}? This will remove all face data and associations.`
      )
    ) {
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Alert variant="destructive">
            ...
            <AlertDescription className="mt-2">
              Unable to connect to the face recognition service. Please check
  ...
  return (
    <div className={containerClass}>
      ...
      <div
        className={`container mx-auto px-4 max-w-6xl ${isMobile ? 'py-4' : 'py-8'}`}
      >
        {!config?.enabled ? (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>
                Enable face recognition to start identifying and labeling
                recurring visitors.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Tabs defaultValue="persons" className="space-y-6">
            <TabsList
              className={`grid w-full bg-muted ${isMobile ? 'grid-cols-2' : 'grid-cols-3'}`}
            >
              <TabsTrigger
                value="persons"
              ...
              >
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {
                        safePersons.filter((p) => (p.detection_count || 0) > 0)
                          .length
                      }
                    </div>
                  </CardContent>
